        ...
        <div class="cartmini__top-wrapper">
            <div class="cartmini__top p-relative">
                <div class="cartmini__top-title">
                    <h4>Shopping cart items: {{count(Cart::content())}}</h4>
                </div>
            ...
            <div class="cartmini__shipping">
                <p> Free Shipping for all orders over <span>TK. 2000</span></p>
                <div class="progress">
                    ...
                    <div class="cartmini__widget-item">
                        ...
                        <div class="cartmini__content">
                            ...
                            <div class="cartmini__price-wrapper">
                                ...
                                <span class="cartmini__price"> = {{$item->price * $item->qty}}</span>
                            </div>
                        </div>
                        <a href="{{ route('cart.remove',['rowId'=>$item->rowId]) }}" class="cartmini__del"><i class="fa-regular fa-xmark"></i></a>
                    </div>
                @endforeach
            </div>
            <!-- for wp -->
                        ...
                        <div class="tp-header-search pl-70">
                            <form action="#">
                                <div class="tp-header-search-wrapper d-flex align-items-center">
                                    <div class="tp-header-search-box search-container">
                                        <input type="text" placeholder="Search for Products..." id="product-search" autocomplete="off">
                            ...
                            <div class="tp-header-action d-flex align-items-center ml-50">
                                ...
                                <div class="tp-header-action-item">
                                    <button type="button" class="tp-header-action-btn cartmini-open-btn">
                                        ...
                                        <span class="tp-header-action-badge">{{count(Cart::content())}}</span>
                                    </button>
                                </div>
