            ...
            <div class="row">
                <div class="col-xl-12">
                    <div class="tp-about-banner-thumb w-img">
                        <img src="{{asset('/')}}website/assets/img/about/about-big-1.jpg" alt="">
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-xl-12">
                    <div class="tp-about-banner-content">
                        <p>We are thrilled to offer you a wide range of products that you won't find anywhere else.
                            Whether you're shopping for clothing, accessories, gadgets, or home decor, we have something
                            for everyone.</p>

                        <p>Our commitment to quality is reflected in every product we offer. We work with top suppliers
                            and manufacturers to ensure that every item we sell meets our high standards for durability,
                            performance, and style. And with a user-friendly interface and intuitive navigation,
                            shopping on our site is a breeze. We understand that security is a top concern for online
                            shoppers, which is why we employ the latest encryption technologies and follow industry best
                            practices to keep your personal information safe. And with fast, reliable shipping options,
                            you can enjoy your purchases in no time.</p>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="tp-counter-wrapper d-flex flex-wrap justify-content-between">
                        <div class="tp-counter-item d-flex align-items-start mb-30">
                            ...
                            <div class="tp-counter-content">
                                <h4>
                                    <span class="purecounter" data-purecounter-duration="1" data-purecounter-end="750">0</span>+
                                </h4>
                                <p>Happy Customers</p>
                            </div>
                        </div>
                        <div class="tp-counter-item d-flex align-items-start mb-30">
                            ...
                            <div class="tp-counter-content">
                                <h4><span class="purecounter" data-purecounter-duration="1" data-purecounter-end="2016">0</span>
                                </h4>
                                <p>Founding Year</p>
                            </div>
                        </div>
                        <div class="tp-counter-item d-flex align-items-start mb-30">
                            ...
                            <div class="tp-counter-content">
                                <h4>
                                    <span class="purecounter" data-purecounter-duration="1" data-purecounter-end="120">0</span>+
                                </h4>
                                <p>Product Orders</p>
                            </div>
                        </div>
                        <div class="tp-counter-item d-flex align-items-start mb-30">
                            ...
                            <div class="tp-counter-content">
                                <h4>
                                    <span class="purecounter" data-purecounter-duration="1" data-purecounter-end="60">0</span>+
                                </h4>
                                            ...
                                            <div class="tp-history-wrapper pr-45">
                                                <div class="tp-history-content mb-40">
                                                    ...
                                                    <p>At our eCommerce site, we are passionate about providing our
                                                        ...
                                                        we are committed to exceeding your expectations.</p>
                                        ...
                                        <div class="col-xl-7 col-lg-6 col-md-6">
                                            <div class="tp-history-thumb-wrapper ml-150 p-relative">
                                                ...
                                                <div class="tp-history-thumb m-img">
                                                    <img src="{{asset('/')}}website/assets/img/history/history-1.jpg" alt="">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xl-7 col-lg-6 col-md-6">
                                            <div class="tp-history-thumb-wrapper ml-150 p-relative">
                                                ...
                                                <div class="tp-history-thumb m-img">
                                                    <img src="{{asset('/')}}website/assets/img/history/history-2.jpg" alt="">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
    ...
    <section class="tp-author-area pb-120">
        <div class="container">
            <div class="tp-author-inner p-relative z-index-1 tp-author-bg-overlay fix" data-bg-color="#821F40">
                ...
                <div class="tp-author-bg include-bg " data-background="{{asset('/')}}website/assets/img/author/author-bg.jpg"></div>
                        ...
                        <div class="tp-author-wrapper p-relative z-index-1">
                            <div class="tp-author-info-wrapper d-flex align-items-center mb-30">
                                <div class="tp-author-info-avater mr-10">
                                    <img src="{{asset('/')}}website/assets/img/users/user-4.jpg" alt="user">
                                </div>
                            ...
                            <div class="tp-author-content">
                                <p>We work with top suppliers and manufacturers to ensure that every item we sell meets
                                    our high standards for durability, performance, and style.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-6 col-lg-6">
                        <div class="tp-author-brand-wrapper d-flex flex-wrap align-items-center justify-content-lg-end">
                            <div class="tp-author-brand-item text-center">
                                <img src="{{asset('/')}}website/assets/img/brand/author/logo_01.png" alt="">
                            </div>
                            <div class="tp-author-brand-item text-center">
                                <img src="{{asset('/')}}website/assets/img/brand/author/logo_02.png" alt="">
                            </div>
                            <div class="tp-author-brand-item text-center">
                                <img src="{{asset('/')}}website/assets/img/brand/author/logo_03.png" alt="">
                            </div>
                            <div class="tp-author-brand-item text-center">
                                <img src="{{asset('/')}}website/assets/img/brand/author/logo_04.png" alt="">
                            </div>
                        </div>
                    </div>
                </div>
