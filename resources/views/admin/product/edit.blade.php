                ...
                <div class="card-body">
                    ...
                    <form class="form-horizontal" action="{{route('product.update', $product->id)}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-9">
                                <input class="form-control" name="name" value="{{$product->name}}" id="categoryName" placeholder="Product Name" type="text">
                            </div>
                        </div>
                        <div class="row mb-4">
                            <label for="categoryName" class="col-md-3 form-label">Product Code</label>
                            <div class="col-md-9">
                                <input class="form-control" name="code" id="categoryName" value="{{$product->code}}" placeholder="Product Code" type="text">
                            </div>
                        </div>
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-9">
                                <textarea class="form-control" name="long_description" id="summernote" value="{{$product->name}}" placeholder="long Description">{{$product->long_description}}</textarea>
                            </div>
                        </div>
                        <div class="row mb-4">
