...
<head>
    <meta charset="utf-8"/>
    <title>Shofy - Order Invoice</title>
        ...
        <tr class="top">
            <td colspan="4">
                <table>
                    <tr>
                        <td class="title">
                            <img src="{{ public_path('website/assets/img/logo/logo.svg') }}" style="width: 70%; max-width: 300px"/> <!-- asset() not working so public_path() used -->
                        </td>
                        <td>
                            Invoice #: {{$order->id}}<br/>
