                ...
                <div class="card-body">
                    ...
                    <form class="form-horizontal" action="{{ route('courier.store') }}" method="POST"
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-9">
                                <input class="form-control" name="name" id="categoryName" placeholder="Courier Name"
                                    type="text">
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-9">
                                <input class="form-control" name="email" id="email" placeholder="Courier Email"
                                    type="email">
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-9">
                                <input class="form-control" name="mobile" id="mobile" placeholder="Courier Mobile"
                                    type="number">
                                <span
