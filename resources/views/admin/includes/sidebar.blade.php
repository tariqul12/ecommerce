    ...
    <div class="app-sidebar">
        ...
        <div class="main-sidemenu">
            ...
            <ul class="side-menu">
                ...
                <li class="slide">
                    <a class="side-menu__item has-link" data-bs-toggle="slide" target="_blank"
                        href="{{ route('home') }}">
                ...
                <li class="slide">
                    ...
                    <ul class="slide-menu">
                        ...
                        {{-- <li><a href="{{ route('user.create') }}" class="slide-item">Add Role</a>
                        </li>
                        <li><a href="{{ route('user.index') }}" class="slide-item">Manage Role</a>
                        </li> --}}
                    </ul>
                </li>
                <li class="slide">
                    ...
                    <ul class="slide-menu">
                        <li><a href="{{ route('slider.create') }}" class="slide-item"> Add Slider</a>
                        </li>
                        <li><a href="{{ route('slider.index') }}" class="slide-item">Manage Slider</a>
                        </li>
                    </ul>
                </li>
                <li class="slide">
                    ...
                    <ul class="slide-menu">
                        <li><a href="{{ route('category.create') }}" class="slide-item">Add Category</a>
                        </li>
                ...
                <li class="slide">
                    ...
                    <ul class="slide-menu">
                        <li><a href="{{ route('sub-category.create') }}" class="slide-item">Add Sub
                                Category</a></li>
                ...
                <li class="slide">
                    <a class="side-menu__item" data-bs-toggle="slide" href="#">
                        ...
                        <span class="side-menu__label">Product Module</span><i
                            class="angle fa fa-angle-right"></i></a>
                    <ul class="slide-menu">
                        <li><a href="{{ route('product.create') }}" class="slide-item">Add Product</a>
                        </li>
                ...
                <li class="slide">
                    <a class="side-menu__item" data-bs-toggle="slide" href="#">
                        ...
                        <span class="side-menu__label">Courier Module</span><i
                            class="angle fa fa-angle-right"></i></a>
                    <ul class="slide-menu">
                        <li><a href="{{ route('courier.create') }}" class="slide-item">Add Courier</a>
                        </li>
                        <li><a href="{{ route('courier.index') }}" class="slide-item">Manage Courier</a>
                        </li>
                    </ul>
                </li>
